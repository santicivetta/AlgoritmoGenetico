...
public class Poblacion {
    ...
    //Metodos
    public Individuo fitTest() {
        for (int i = 0; i < this.getIndividuos().size(); i++) {
            if (this.getIndividuos().get(i).getFitness(this.getSolucion()) == this.getSolucion().getFitness(this.getSolucion())) {
    ...
    public void seleccion() {
        ...
        for (int i = 0; i < this.getIndividuos().size(); i++) {
            ...
            //System.out.println("IND" + randomId + " Hexa: " + indiv1.getHexa() + "||| Bin: " + indiv1.getBin() + "||| Fitness: " + indiv1.getFitness(this.getSolucion()));
            //System.out.println("vs.");
            //System.out.println("IND" + randomId2 + " Hexa: " + indiv2.getHexa() + "||| Bin: " + indiv2.getBin() + "||| Fitness: " + indiv2.getFitness(this.getSolucion()));System.out.println();
    ...
    public void mutarPob(Integer maximoAMutar) {
        ...
        int individuo;
        //recorre toda la poblacion pero puede ser que haya individuos que no muten
    ...
    public void cruce() {
        ...
        for(int i=0;i<this.getIndividuos().size();i=i+2){
            ...
            //System.out.println("Cruce entre: Cromosoma " + indi1 + " Cromosoma " + indi2);
            puntoCruce=rand.nextInt(40);
            //System.out.println("Punto de Cruce: " + puntoCruce);
            //System.out.println("Anter Cromosoma " + indi1 + " " + this.getIndividuos().get(indi1).getBin() );
            ...
            this.getIndividuos().get(indi1).setHexa(this.toHexa(aux));
            
            //System.out.println("Nuevo Cromosoma " + indi1 + " " + this.getIndividuos().get(indi1).getBin() );
            //System.out.println("Anter Cromosoma " + indi2 + " " + this.getIndividuos().get(indi2).getBin() );
            ...
            this.getIndividuos().get(indi2).setHexa(this.toHexa(aux));
            
            //System.out.println("Nuevo Cromosoma " + indi2 + " " + this.getIndividuos().get(indi2).getBin() );
        }
    }
    ...
    public void imprimirPoblacion(){
        System.out.println("SOLUCION Hexa: " + this.getSolucion().getHexa() + "||| Bin: " + this.getSolucion().getBin() + "||| Fitness: " + this.getSolucion().getFitness(this.getSolucion()));
        for(int i=0;i<this.getIndividuos().size();i++){
            System.out.println("INDIVID" + i + " Hexa: " + this.getIndividuos().get(i).getHexa() + "||| Bin: " + this.getIndividuos().get(i).getBin() + "||| Fitness: " + this.getIndividuos().get(i).getFitness(this.getSolucion()));
        }
        System.out.println();
    }
}